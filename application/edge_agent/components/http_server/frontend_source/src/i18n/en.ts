export const en = {
  ...
  mcpDesc: 'Configure remote MCP servers. Servers added here are available to the LLM via the simplified mcp_call tool.',
  ...
  mcpAddOk: 'MCP server added',
  mcpRemoveOk: 'MCP server removed',
  mcpName: 'Name',
  mcpUrl: 'URL',
  mcpToken: 'Token',
  mcpTokenPlaceholder: 'Bearer token (leave empty if none)',
  mcpEndpoint: 'Endpoint',
  mcpDescription: 'Description',
  mcpDescPlaceholder: 'Optional description',
  mcpNameUrlRequired: 'Name and URL are required',
  mcpReloadHint: 'Changes take effect immediately. The LLM will see updated server list on next tool invocation.',
  mcpType: 'Type',
  mcpTypeHttp: 'HTTP',
  mcpTypeSse: 'SSE (Streaming)',
  mcpEnabled: 'Enabled',
