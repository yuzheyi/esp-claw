export const en = {
  ...
  sysInfoNone: 'n/a',
  sysInfoInternalStorage: 'Internal Storage',
  sysInfoSdCard: 'SD Card',
  sysInfoSdMounted: 'Mounted',
  sysInfoSdNotFound: 'Not detected',
  sysInfoRemaining: 'free',
  ...
  fileInternalStorage: 'Internal Storage',
  fileSdCard: 'SD Card',
