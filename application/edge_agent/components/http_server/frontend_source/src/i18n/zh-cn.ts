...
export const zhCn: Dict = {
  ...
  mcpDesc: '配置远程 MCP 服务器。添加后 LLM 可通过简化版的 mcp_call 工具自动填充 URL 和 Token 来调用。',
  ...
  mcpSaving: '保存中…',
  mcpRemoveBtn: '删除',
  mcpRemoveConfirm: '确定删除 MCP 服务器 "{name}" 吗？',
  mcpAddOk: 'MCP 服务器已添加',
  mcpRemoveOk: 'MCP 服务器已删除',
  mcpName: '名称',
  mcpUrl: 'URL',
  mcpToken: 'Token',
  mcpTokenPlaceholder: 'Bearer Token（可不填）',
  mcpEndpoint: '端点',
  mcpDescription: '描述',
  mcpDescPlaceholder: '可选描述',
  mcpNameUrlRequired: '名称和 URL 为必填项',
  mcpReloadHint: '修改立即生效。LLM 下次调用工具时将看到更新后的服务器列表。',
  mcpType: '类型',
  mcpTypeHttp: 'HTTP',
  mcpTypeSse: 'SSE（流式）',
  mcpEnabled: '已启用',
