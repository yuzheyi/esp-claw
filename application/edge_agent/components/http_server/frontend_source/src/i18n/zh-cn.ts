...
export const zhCn: Dict = {
  ...
  sysInfoApIp: '配网热点 IP',
  sysInfoStorage: '存储路径',
  sysInfoSdCardStatus: '状态',
  sysInfoSdCardMounted: '已挂载',
  sysInfoSdCardNotMounted: '未挂载',
  sysInfoSdCardMountPoint: '挂载路径',
  sysInfoSdCardTotal: '总容量',
  sysInfoSdCardUsed: '已使用',
  sysInfoSdCardFree: '可用空间',
  sysInfoSdCardUsage: '使用率',
  sysInfoNone: '—',
  sysInfoReload: '刷新状态',
  sysInfoRestart: '重启设备',
